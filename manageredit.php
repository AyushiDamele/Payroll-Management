...
<form action="managerupdatedetails.php" method="POST"> 
...
<td class="mid"> : </td>
<td class="right">
<input type="text" name="ename" REQUIRED placeholder="Enter Your Name" value="<?php echo $_SESSION['name']?>" pattern="[a-zA-Z]{0,400}" title="Valid Name Consistings of a-z or A-Z only" />
</td>
</tr>
<td class="left"> Email-ID <font style="color:red">*</font></td>
<td class="mid"> : </td>
<td class="right">
<input type="email" name="eemail" REQUIRED placeholder="Enter A Valid Email-Id " value="<?php echo $_SESSION['email']?>"  pattern="[a-zA-Z0-9._%+-]+@[a-zA-Z.-]+\.[a-zA-Z]{2,3}$" title="Enter A Valid Email-Id user@domain.com or user@domain.in" required/>
</td>
</tr>
...
<table width="80%">
<tr>
<td class="left">New Password (by deault old is here)<font style="color:red">*</font></td>
<td class="mid"> : </td>
<td class="right">
<input type="password" name="newpass" REQUIRED pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" value="<?php echo $_SESSION['pass']?>" placeholder="Enter Your New Password Here "  title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" />
</td>
</tr>
</table>
</center>
